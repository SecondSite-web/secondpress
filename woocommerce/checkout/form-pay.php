	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'secondpress' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'secondpress' ); ?></th>
			</tr>
		</thead>
		<tbody>
